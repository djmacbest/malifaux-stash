...
### Latest Updates
- Phase 1 complete with advanced filtering and wishlist view
- Multi-select filters with smart OR/AND logic
- Wishlist view showing SKU-grouped purchasing options
...
**Display formatting:**
- Keywords, Edition, Characteristics: Converted to `, ` (comma-space) for display
- SKU: Converted to ` / ` (space-slash-space) for display
...
- Backend converts to `, ` for most fields, ` / ` for SKUs (user-friendly display)
